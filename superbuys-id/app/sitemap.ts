...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return languages.flatMap((lang) => pages.map((page) => ({ url: `${base}${lang}${page}/`, lastModified: new Date("2026-08-13"), changeFrequency: page.includes("articles/") ? "monthly" as const : "weekly" as const, priority: page === "" ? 1 : .75 })));
}
