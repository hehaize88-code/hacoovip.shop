...
export const englishArticles: Record<string, LongArticle> = {
  "spreadsheet-guide": {
    ...
    description:
      "A practical, product-first workflow for finding listings, checking options, using warehouse QC photos and planning a Superbuy parcel without treating a spreadsheet as a guarantee.",
    primaryKeyword: "how to use Superbuy spreadsheet",
    secondaryKeywords: [
      "Superbuy spreadsheet 2026",
      "Superbuy product links",
      "Superbuy QC photos",
      "Superbuy buying guide",
    ],
    sections: [
      {
      ...
      },
      {
        ...
        bullets: [
          "Product URL and screenshot",
          "Selected colour, size and quantity",
          "Key measurement or option code",
          "Any seller promise that affects the order",
        ],
      },
      {
  ...
  "qc-photo-checklist": {
    ...
    description:
      "Learn what Superbuy QC photos can verify, what standard inspection cannot prove, and when to request a targeted detailed photo before international shipping.",
    primaryKeyword: "Superbuy QC photos",
    secondaryKeywords: [
      "how to read Superbuy QC photos",
      "Superbuy warehouse photos",
      "Superbuy quality inspection",
      "Superbuy detailed photos",
    ],
    sections: [
      {
  ...
  "shipping-cost-guide": {
    ...
    description:
      "A fact-checked guide to Superbuy product costs, domestic delivery, warehouse consolidation, chargeable weight, shipping deposits and final reconciliation in 2026.",
    primaryKeyword: "Superbuy shipping cost",
    secondaryKeywords: [
      "Superbuy shipping calculator",
      "Superbuy shipping deposit",
      "Superbuy parcel weight",
      "Superbuy fees 2026",
    ],
    sections: [
      {
