      ...
      <article className="article">
        ...
        <figure className="wrap article-cover">
          <img
            ...
            width={image.width}
            height={image.height}
            alt={`${g.title} visual research reference`}
          />
        </figure>
        <div className="wrap article-body">
          <aside>
            ...
            <a href="#quick-process">Quick process</a>
          </aside>
          <div className="article-content">
            {c.sections.map(([h, p]) => (
              <section id={h.toLowerCase().replaceAll(" ", "-")} key={h}>
                <h2>{h}</h2>
                <p>{p}</p>
              </section>
            ))}
            ...
            {slug === "shipping-planning" && (
              <p>
                ...
                <Link href="/articles/hacoo-after-sales-request-window-evidence/">
                  Hacoo after-sales request window and evidence checklist
                </Link>{" "}
                to preserve the displayed delivery date, item record and request
                timestamp.
              </p>
            )}
            {slug === "shipping-planning" && (
              <>
                <p>
                  Received only part of a multi-item order? Use the{" "}
                  <Link href="/articles/hacoo-order-missing-item-split-shipment/">
                    Hacoo split-shipment and missing-item checklist
                  </Link>{" "}
                  before choosing a support path.
                </p>
                <p>
                  An item still marked preorder or backorder needs a different
                  record. Follow the{" "}
                  <Link href="/articles/hacoo-preorder-backorder-support/">
                    Hacoo preorder support guide
                  </Link>{" "}
                  before tracking is assigned.
                </p>
              </>
            )}
            <div className="article-callout">
              <h2>Continue with a live category</h2>
              <p>
                Use the guide as context, then confirm current information on
        ...
        <div className="wrap">
          <div className="section-heading compact">
            <div>
              ...
              <h2>Related Hacoo guides.</h2>
            </div>
            <Link className="text-link large" href="/guides/">
              View all guides <Arrow size={17} />
            </Link>
          </div>
