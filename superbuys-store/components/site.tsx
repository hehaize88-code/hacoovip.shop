...
function ArticlePage({ locale, basePath, slug }: { locale: Locale; basePath: string; slug: string }) {
  ...
  const publishDate = slug === "superbuy-warehouse-arrival-checklist" ? "2026-08-14" : "2026-08-12";
  ...
  const sourceText = isArrivalGuide
