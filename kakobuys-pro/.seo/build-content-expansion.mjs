...
function footer() {
  return `<footer class="site-footer"><div class="shell footer-grid">
    <div><a href="/" class="logo" aria-label="Kakobuys Pro home"><img class="logo-image" src="/kakobuy-logo.png" alt="Kakobuy" width="642" height="162"></a><p>Independent Kakobuy spreadsheet research, QC education and product-link discovery.</p></div>
  ...
  </div><div class="shell legal-row"><p>© 2026 Kakobuys.pro. Independent resource.</p><p>Not affiliated with Kakobuy or any marketplace or brand referenced.</p></div></footer>`;
}
...
function documentHead({ title, description, canonical, type = "website", keywords = [], image = `${site}/kakobuy-logo.png` }) {
  ...
  <meta name="creator" content="Kakobuys.pro Research Desk">
...
function articlePage(article) {
  ...
  const schema = {
    ...
    isPartOf: {"@type": "WebSite", name: "Kakobuys.pro", url: site}
  };
  ...
  ${documentHead({
    title: `${article.title} | Kakobuys.pro`,
    description: article.description,
    canonical,
    type: "article",
    keywords: article.keywords,
  ...
  <main>
    <section class="page-hero"><div class="shell">
      ...
      <div class="article-byline"><span>By Kakobuys.pro Research Desk</span><span>${escapeHtml(article.readTime)} read</span><span>${count.toLocaleString("en-US")} words</span><span>Reviewed ${displayDate}</span></div>
    </div></section>
...
function articleIndex() {
  ...
  return `<!doctype html><html lang="en"><head>
  ${documentHead({
    title: "Kakobuy Guides, QC Research & Shipping Articles | Kakobuys.pro",
