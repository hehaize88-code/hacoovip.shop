...
export const pageSeo: Record<Lang, Record<SeoRoute, SeoEntry>> = {
  en: {
    ...
    shipping: { title: "Superbuy International Shipping 2026 | Cost & Routes", h1: "Superbuy International Shipping Guide 2026", description: "Plan Superbuy international shipping by parcel weight, volume, route restrictions and consolidation. Understand what changes the final cost before submitting a parcel." },
