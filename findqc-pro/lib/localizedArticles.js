...
const ENGLISH_UI = {
  ...
  journalNote: "Every article is checked against current FindQC-owned pages and linked to its official source notes. Images are clearly marked editorial examples rather than warehouse QC evidence.",
  ...
  officialSources: "Official sources checked",
  sourceIntro: "This independent editorial guide was checked against the following FindQC-owned pages on 20 July 2026. Product features and policies can change, so verify current details at the source.",
