...
const pageSeoTitles: Record<Lang, Record<PageKey, string>> = {
  ...
  it: { home: "Hipobuy Spreadsheet 2026 | Link prodotto verificati", spreadsheet: "Hipobuy Spreadsheet | Link prodotto ricercabili", categories: "Categorie prodotti Hipobuy | Scarpe, maglie e altro", qc: "Foto QC Hipobuy | Checklist del magazzino", shipping: "Costi di spedizione Hipobuy | Guida alla pianificazione", faq: "FAQ Hipobuy | QC, deposito, spedizioni e resi", articles: "Guide all'acquisto Hipobuy | Spreadsheet, QC e spedizioni" },
