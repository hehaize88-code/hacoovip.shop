...
const en = {
  nav: { home: "Home", spreadsheet: "Spreadsheet", categories: "Categories", qc: "QC Guide", shipping: "Shipping", faq: "FAQ", articles: "SEO Articles" },
  common: {
    independent: "Independent directory", checked: "Links checked 14 Aug 2026", review: "Review build · noindex",
  ...
  home: {
    ...
    guidesKicker: "Research notes", guidesTitle: "Useful guides, kept separate from the sheet.", guidesIntro: "SEO content supports the directory instead of hiding the product rows below long articles.",
  ...
  pages: {
    ...
    articles: { kicker: "SEO research library", title: "Practical Hipobuy guides with a clear search intent.", intro: "Each topic answers one real decision instead of repeating the same spreadsheet keywords across every page." },
  },
  categories: {
...
const de = {
  nav: { home: "Startseite", spreadsheet: "Tabelle", categories: "Kategorien", qc: "QC-Ratgeber", shipping: "Versand", faq: "FAQ", articles: "SEO-Artikel" },
  common: {
    independent: "Unabhängiges Verzeichnis", checked: "Links geprüft am 14. Aug. 2026", review: "Prüfversion · noindex",
  ...
  home: {
    ...
    guidesKicker: "Recherche-Notizen", guidesTitle: "Nützliche Ratgeber getrennt von der Tabelle.", guidesIntro: "SEO-Inhalte unterstützen das Verzeichnis, statt die Produktzeilen unter langen Texten zu verstecken.",
  ...
  pages: {
    ...
    articles: { kicker: "SEO-Recherchebibliothek", title: "Praktische Hipobuy-Ratgeber mit klarer Suchabsicht.", intro: "Jedes Thema beantwortet eine reale Entscheidung, statt auf jeder Seite dieselben Tabellen-Keywords zu wiederholen." },
  },
  categories: {
...
const it = {
  ...
  shippingFactors: [["Peso reale", "Peso misurato dopo il consolidamento."], ["Peso volumetrico", "Calcolo basato sulle dimensioni che può essere superiore."], ["Restrizioni di rotta", "Batterie, liquidi e marchi possono limitare le linee."], ["Regole del paese", "Tasse, dogana e consegna variano."]],
