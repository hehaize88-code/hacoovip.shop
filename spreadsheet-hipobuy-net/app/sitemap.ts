...
export default function sitemap():MetadataRoute.Sitemap {
  ...
  const routes=["/","/spreadsheet/","/categories/","/qc-guide/","/shipping/","/faq/","/articles/","/articles/how-to-buy-with-hipobuy/","/articles/hipobuy-qc-photos/","/articles/hipobuy-shipping-cost/"];
