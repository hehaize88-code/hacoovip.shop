...
export const metadata:Metadata={title:"Hipobuy QC Photos Guide 2026: Checklist Before Approval",description:"Check Hipobuy QC photos for size, variants, measurements, construction and damage before warehouse approval, exchange or return.",alternates:{canonical:"/qc-guide/"}};
const checks=[
