	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("form", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("button", {
				type: "submit",
				children: ["Search ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "↗" })]
			})
		]
	});
}
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: product.price }), mode === "c" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [
						...
						product.score,
						"%"
					] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "View find ↗" })]
				})
			]
		})]
	});
...
function Footer({ mode }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("footer", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Concept preview · 2026" })
		]
	});
}
//#endregion
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				paragraphs: ["Public app reviews show mixed experiences. Some users praise the interface, order tracking or customer support, while others complain that shipping was much higher than the product value or that route information felt unclear. These accounts are useful because they highlight the questions a buyer should ask: What were the destination, packed weight, dimensions, category, route and date? Was the amount an estimate or final charge? Were destination fees included?", "A review is not a universal price table. One user’s parcel may differ in country, volume, line, timing and contents. Use repeated complaints as prompts for verification, not as proof that your parcel will cost the same. Likewise, a positive delivery story does not guarantee your route or customs outcome. A balanced review article should preserve this context and clearly label customer statements as individual experiences."],
				checklist: [
...
var localeCopy = {
	...
	de: {
		...
		pages: {
			...
			categories: ["Nach Kategorie", "Wähle eine Abteilung und öffne die passende Kollektion."],
			"qc-guide": ["QC-Fotos richtig prüfen", "Checkliste für Form, Details, Maße und sichtbare Mängel vor dem Versand."],
			"shipping-guide": ["Paket planen", "Kosten hängen von Ziel, Größe, Gewicht und Artikelart ab."],
			articles: ["Ratgeber-Bibliothek", "Faktenbasierte Anleitungen zu Suche, Prüfung und Paketplanung."],
			faq: ["Häufige Fragen", "Klare Antworten zu Index, Links, QC-Fotos, Preisen und Versand."]
		},
		qc: [
			["Artikel bestätigen", "Name, Farbe und Größe zuerst mit der Bestellung abgleichen."],
			["Alle Winkel prüfen", "Vorderseite, Rückseite, Seiten und Nahaufnahmen prüfen."],
			["Maße nutzen", "Etiketten sind keine Maße. Mit eigener Kleidung vergleichen."],
			["Details vergrößern", "Nähte, Drucke, Stickerei, Verschlüsse und Beschläge prüfen."],
			["Vor Versand entscheiden", "Unklare Details klären, solange der Artikel im Lager ist."]
		],
		shipping: [
			["Paket zusammenstellen", "Nur versandbereite Artikel bündeln und Maße prüfen."],
			["Einschränkungen prüfen", "Akkus, Flüssigkeiten und sensible Waren können Routen begrenzen."],
			["Abrechnungsgewicht vergleichen", "Es kann reales oder Volumengewicht gelten."],
			["Schutz wählen", "Unnötige Verpackung entfernen, Zerbrechliches schützen."],
			["Aktuelles Angebot prüfen", "Routen und Preise ändern sich; maßgeblich ist das aktuelle Angebot."]
		],
		articles: [
			[
		...
		faq: [
			["Ist dies die offizielle AllChinaBuy-Seite?", "Nein. Dies ist eine unabhängige Produktsuche."],
			["Wohin führen Produktbuttons?", "Direkt zum Produkt unseres Einkaufsziels, nicht zu AllChinaBuy."],
			["Sind Preise endgültig?", "Nein. Optionen, Kurse und Versand ändern den Endbetrag."],
			["Was sind QC-Fotos?", "Lagerfotos zur Prüfung vor dem internationalen Versand."],
			["Garantieren sie Qualität?", "Nein. Sie zeigen sichtbare, aber nicht alle versteckten Details."],
			["Kann ich nach Namen suchen?", "Ja. Das Stichwort wird an den Produktkatalog übergeben."],
	...
	fr: {
		...
		pages: {
			products: ["Base de produits", "Produits sélectionnés avec images, prix USD et lien direct."],
			categories: ["Par catégorie", "Choisissez un rayon puis ouvrez la collection."],
			"qc-guide": ["Lire les photos QC", "Vérifiez forme, détails, mesures et défauts visibles."],
			"shipping-guide": ["Planifier le colis", "Le coût dépend du pays, du volume, du poids et du type d’article."],
			articles: ["Bibliothèque de guides", "Conseils factuels sur la recherche, le contrôle et l’expédition."],
			faq: ["Questions fréquentes", "Réponses sur l’index, les liens, les photos QC et les coûts."]
		},
		qc: [
			["Confirmer l’article", "Comparez nom, couleur et taille avec la commande."],
			...
			["Zoomer sur les détails", "Inspectez coutures, impressions, broderies et fermetures."],
			["Décider avant l’envoi", "Demandez une précision tant que l’article est à l’entrepôt."]
		],
		shipping: [
			["Composer le colis", "Regroupez les articles prêts et vérifiez les dimensions."],
			["Vérifier les restrictions", "Batteries, liquides et articles sensibles peuvent limiter les lignes."],
			["Comparer le poids facturé", "Le poids réel ou volumétrique peut s’appliquer."],
			["Choisir la protection", "Retirez le superflu mais protégez les objets fragiles."],
			["Vérifier le devis", "Lignes et prix changent; confirmez au moment de l’envoi."]
		],
		articles: [
			[
		...
		faq: [
			["Est-ce le site officiel AllChinaBuy ?", "Non. C’est un guide indépendant."],
			["Où mènent les boutons ?", "Vers la fiche exacte de notre destination, pas vers AllChinaBuy."],
			["Les prix sont-ils définitifs ?", "Non. Options, change et livraison modifient le total."],
			["Que sont les photos QC ?", "Des photos d’entrepôt avant l’envoi international."],
			["Garantissent-elles la qualité ?", "Non. Elles montrent certains défauts, pas tous les détails cachés."],
			["Puis-je chercher par nom ?", "Oui. Le mot-clé est transmis au catalogue."],
			["Pourquoi la livraison peut-elle coûter plus ?", "Pays, ligne, poids et volume déterminent le coût."],
			["Liens vers d’autres agents ?", "Non. Tous les boutons gardent une seule destination."]
		]
	},
	es: {
		name: "Español",
		...
		pages: {
			products: ["Base de productos", "Productos seleccionados con imágenes, precio USD y enlace directo."],
			categories: ["Explorar categorías", "Elige un departamento y abre su colección."],
			"qc-guide": ["Cómo leer fotos QC", "Comprueba forma, detalles, medidas y defectos visibles."],
			"shipping-guide": ["Planifica el paquete", "El coste depende de destino, tamaño, peso y tipo."],
			articles: ["Biblioteca de guías", "Consejos basados en hechos sobre búsqueda, control y envío."],
			faq: ["Preguntas frecuentes", "Respuestas sobre el índice, enlaces, fotos QC y costes."]
		},
		qc: [
			["Confirmar el artículo", "Compara nombre, color y talla con el pedido."],
			["Revisar todos los ángulos", "Mira frente, espalda, laterales y primeros planos."],
			...
			["Decidir antes del envío", "Aclara dudas mientras el artículo sigue en almacén."]
		],
		shipping: [
			["Crear el paquete", "Agrupa artículos listos y verifica dimensiones."],
			["Revisar restricciones", "Baterías, líquidos y artículos sensibles pueden limitar rutas."],
			...
			["Verificar cotización", "Rutas y precios cambian; confirma el importe actual."]
		],
		articles: [
			[
		...
		faq: [
			...
			["¿A dónde llevan los botones?", "A la ficha exacta de nuestro destino, no a AllChinaBuy."],
			["¿Son precios finales?", "No. Opciones, cambio y envío modifican el total."],
			["¿Qué son las fotos QC?", "Fotos de almacén antes del envío internacional."],
			["¿Garantizan calidad?", "No. Ayudan con defectos visibles, no con todo lo oculto."],
			["¿Puedo buscar por nombre?", "Sí. La palabra se envía al catálogo."],
			["¿Por qué el envío puede costar más?", "Destino, ruta, peso y volumen determinan el precio."],
			["¿Hay enlaces a otros agentes?", "No. Todos los botones usan un destino."]
		]
	},
	it: {
		name: "Italiano",
		...
		qc: [
			...
			["Decidi prima dell’invio", "Chiedi chiarimenti mentre il prodotto è in magazzino."]
		],
		shipping: [
			...
			["Scegli la protezione", "Riduci l’imballo ma proteggi gli oggetti fragili."],
		...
		faq: [
			...
			["Garantiscono la qualità?", "No. Aiutano con difetti visibili, non con tutto."],
			["Posso cercare per nome?", "Sì. La parola passa al catalogo."],
			["Perché la spedizione può costare di più?", "Destinazione, linea, peso e volume determinano il costo."],
	...
	pl: {
		...
		pages: {
			products: ["Baza produktów", "Wybrane produkty ze zdjęciami, cenami USD i linkiem."],
			categories: ["Kategorie", "Wybierz dział i otwórz kolekcję."],
			"qc-guide": ["Jak czytać zdjęcia QC", "Sprawdź kształt, detale, wymiary i widoczne wady."],
			"shipping-guide": ["Zaplanuj paczkę", "Koszt zależy od kraju, rozmiaru, wagi i typu."],
			articles: ["Biblioteka poradników", "Rzetelne treści o wyszukiwaniu, kontroli i przesyłce."],
			faq: ["Częste pytania", "Odpowiedzi o indeksie, linkach, zdjęciach QC i kosztach."]
		},
		qc: [
			...
			["Zdecyduj przed wysyłką", "Wyjaśnij wątpliwości, gdy produkt jest w magazynie."]
		],
		shipping: [
			["Zbuduj paczkę", "Połącz gotowe produkty i sprawdź wymiary."],
			["Sprawdź ograniczenia", "Baterie, płyny i wrażliwe towary mogą ograniczać linie."],
			["Porównaj wagę", "Może obowiązywać waga rzeczywista lub objętościowa."],
			["Wybierz zabezpieczenie", "Usuń zbędne opakowania i chroń delikatne rzeczy."],
		...
		faq: [
			["Czy to oficjalna strona AllChinaBuy?", "Nie. To niezależny przewodnik."],
			["Dokąd prowadzą przyciski?", "Do dokładnej karty produktu, nie do AllChinaBuy."],
			["Czy ceny są ostateczne?", "Nie. Opcje, kurs i wysyłka zmieniają sumę."],
			["Czym są zdjęcia QC?", "Zdjęciami magazynowymi przed wysyłką."],
			["Czy gwarantują jakość?", "Nie. Pokazują widoczne wady, nie wszystkie ukryte."],
			["Czy mogę szukać po nazwie?", "Tak. Hasło trafia do katalogu."],
			["Dlaczego wysyłka bywa droższa?", "Kraj, linia, waga i objętość określają cenę."],
			["Czy linkujecie innych agentów?", "Nie. Wszystkie przyciski prowadzą do jednego celu."]
		]
	},
	ro: {
		name: "Română",
		...
		pages: {
			products: ["Bază de produse", "Produse selectate cu imagini, prețuri USD și link direct."],
			categories: ["Explorează categoriile", "Alege un departament și deschide colecția."],
			"qc-guide": ["Cum citești pozele QC", "Verifică forma, detaliile, măsurile și defectele vizibile."],
			"shipping-guide": ["Planifică pachetul", "Costul depinde de destinație, dimensiune, greutate și tip."],
			articles: ["Bibliotecă de ghiduri", "Conținut documentat despre căutare, verificare și livrare."],
			faq: ["Întrebări frecvente", "Răspunsuri despre index, linkuri, poze QC și costuri."]
		},
		qc: [
			["Confirmă produsul", "Compară numele, culoarea și mărimea cu comanda."],
			["Verifică toate unghiurile", "Privește fața, spatele, lateralele și detaliile."],
			["Folosește măsurătorile", "Compară fotografiile cu o piesă pe care o ai."],
			["Mărește detaliile", "Verifică cusături, imprimeuri, broderii și fermoare."],
			["Decide înainte de livrare", "Cere clarificări cât produsul este în depozit."]
		],
		shipping: [
			["Construiește pachetul", "Grupează produsele pregătite și verifică dimensiunile."],
			["Verifică restricțiile", "Bateriile, lichidele și produsele sensibile pot limita rutele."],
			["Compară greutatea", "Se poate folosi greutatea reală sau volumetrică."],
			["Alege protecția", "Elimină ambalajul inutil și protejează obiectele fragile."],
			["Verifică oferta", "Rutele și prețurile se schimbă; confirmă oferta actuală."]
		],
		articles: [
			[
		...
		faq: [
			...
			["Unde duc butoanele produselor?", "La pagina exactă a produsului, nu la AllChinaBuy."],
			["Prețurile sunt finale?", "Nu. Opțiunile, cursul și livrarea schimbă totalul."],
			["Ce sunt pozele QC?", "Fotografii din depozit înainte de transport."],
			["Garantează calitatea?", "Nu. Arată probleme vizibile, nu toate detaliile ascunse."],
			["Pot căuta după nume?", "Da. Termenul este trimis către catalog."],
			["De ce livrarea poate costa mai mult?", "Destinația, ruta, greutatea și volumul determină costul."],
			["Trimiteți către alți agenți?", "Nu. Toate acțiunile folosesc o singură destinație."]
		]
	}
};
var factualFaqExtras = {
	de: [
		["Welche Leistungen beschreibt AllChinaBuy öffentlich?", "Die offizielle App nennt Einkauf, Bestellabwicklung, Qualitätsprüfung, internationale Logistik und Kundendienst; der internationale Versand erfolgt durch Drittanbieter."],
		["Welche Daten braucht eine Versandschätzung?", "Der offizielle Rechner fragt nach Ziel, Warenkategorie, geschätztem Gewicht und gegebenenfalls Paketmaßen."],
		["Ist der Rechnerpreis endgültig?", "Nein. Endmaße, Wareneignung und aktuell verfügbare Linien können das Live-Angebot ändern."],
		["Was prüfe ich vor dem Paketversand?", "Artikel, QC-Nachweise, Gewicht, Maße, Linien-Eignung und den aktuellen Gesamtbetrag prüfen."]
	],
	fr: [
		["Quels services AllChinaBuy décrit-il ?", "L’application officielle cite l’achat, le traitement des commandes, le contrôle qualité, la logistique internationale et le service après-vente; l’envoi international est assuré par des tiers."],
		["Quelles données faut-il pour estimer l’envoi ?", "Le calculateur officiel demande la destination, la catégorie, le poids estimé et, si nécessaire, les dimensions."],
		["Le résultat du calculateur est-il final ?", "Non. Mesures finales, éligibilité et lignes disponibles peuvent modifier le devis réel."],
		["Que vérifier avant l’envoi ?", "Article reçu, preuves QC, poids, dimensions, éligibilité de la ligne et total actuel."]
	],
	es: [
		["¿Qué servicios describe AllChinaBuy?", "La app oficial enumera compra, gestión de pedidos, inspección de calidad, logística internacional y posventa; el envío internacional lo prestan terceros."],
		["¿Qué datos necesita una estimación?", "La calculadora oficial solicita destino, categoría, peso estimado y, cuando corresponde, dimensiones."],
		["¿El resultado es el precio final?", "No. Medidas finales, elegibilidad y rutas disponibles pueden cambiar la cotización real."],
		["¿Qué revisar antes de enviar?", "Producto, pruebas QC, peso, dimensiones, elegibilidad de ruta y total actual."]
	],
	it: [
		["Quali servizi descrive AllChinaBuy?", "L’app ufficiale indica acquisto, gestione ordini, controllo qualità, logistica internazionale e post-vendita; la spedizione internazionale è fornita da terzi."],
		...
		["Il risultato è il prezzo finale?", "No. Misure finali, idoneità e linee disponibili possono cambiare il preventivo reale."],
		["Cosa verificare prima della spedizione?", "Prodotto, prove QC, peso, dimensioni, idoneità della linea e totale attuale."]
	],
	pl: [
		["Jakie usługi opisuje AllChinaBuy?", "Oficjalna aplikacja wymienia zakup, realizację zamówień, kontrolę jakości, logistykę międzynarodową i obsługę posprzedażową; wysyłkę zapewniają firmy zewnętrzne."],
		["Jakie dane są potrzebne do wyceny?", "Oficjalny kalkulator pyta o kraj, kategorię, szacowaną wagę i w razie potrzeby wymiary."],
		["Czy wynik kalkulatora jest ostateczny?", "Nie. Końcowe wymiary, kwalifikacja towaru i dostępne linie mogą zmienić ofertę."],
		["Co sprawdzić przed wysyłką?", "Produkt, zdjęcia QC, wagę, wymiary, dostępność linii i aktualną sumę."]
	],
	ro: [
		["Ce servicii descrie AllChinaBuy?", "Aplicația oficială enumeră achiziția, procesarea comenzilor, controlul calității, logistica internațională și serviciile post-vânzare; transportul internațional este oferit de terți."],
		["Ce date sunt necesare pentru estimare?", "Calculatorul oficial cere destinația, categoria, greutatea estimată și, unde este cazul, dimensiunile."],
		["Rezultatul este prețul final?", "Nu. Dimensiunile finale, eligibilitatea și rutele disponibile pot modifica oferta reală."],
		["Ce verific înainte de expediere?", "Produsul, dovezile QC, greutatea, dimensiunile, eligibilitatea rutei și totalul actual."]
	]
};
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("details", {
						className: "lang-menu",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("summary", { children: [locale.toUpperCase(), "⌄"] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: locales$1.map((l) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("footer", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Independent guide · not affiliated with AllChinaBuy or featured brands." })
			] }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "allchinabuy.ro · 2026" })
		]
	});
}
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "RESULT_SET" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("b", { children: ["2,044 ", t.ui[13]] })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("button", { children: [t.ui[14], " ↓"] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("button", { children: "GRID ▦" })] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			children: t.articles.map(([title, slug, summary], i) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("b", { children: [t.ui[16], " →"] })
				]
			}, slug))
		})]
	});
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			children: t.faq.slice(0, 4).map(([q, a], i) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "FAQ →" })
				]
			}, q))
		})]
	});
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: article.secondaryKeywords.join(" · ") })
					]
				})
			]
		}),
				...
				section === "categories" && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					...
					children: categories.map(([, , url], i) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("i", { children: [t.ui[17], " ↗"] })
						]
					}, url))
				}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						className: "nav-cta",
						href: "#drops",
						children: ["Browse finds ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "↗" })]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "live-chip",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {}), " UPDATED AUG 12 · 2026"]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "A sharper AllChinaBuy spreadsheet experience—curated products, clear USD prices and a direct path to every find." }),
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("b", { children: [products[3].price, " ↗"] })
							] })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "A weekly edit of standout fashion finds—selected for people with taste, not time." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "THE SHORTLIST · 08.12.26" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"Eight good reasons",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							"to stop scrolling."
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				id: "notes",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "FIELD NOTE № 04" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("blockquote", { children: "“The best spreadsheet isn't the longest one. It's the one that helps you decide.”" }),
...
async function generateMetadata$1({ params }) {
	...
	return {
		title: `${page[0]} — AllChinaBuy Spreadsheet`,
		description: page[1],
		alternates
	};
}
