...
export const localeContent: Record<SupportedLocale, LocaleContent> = {
  fr: {
    ...
    search: "Rechercher",
    searchFormLabel: "Rechercher dans le catalogue principal",
  ...
  de: {
    ...
    search: "Suchen",
    searchFormLabel: "Den Hauptkatalog durchsuchen",
  ...
  it: {
    ...
    search: "Cerca",
    searchFormLabel: "Cerca nel catalogo principale",
  ...
  es: {
    ...
    search: "Buscar",
    searchFormLabel: "Buscar en el catálogo principal",
